...
if __name__ == '__main__':
    ...
    num_classes = 4
    source_input_size_full = [256, 256]
    target_input_size_full = [256, 256]
    source_input_size = [256, 256]
    ...
    source_loader= torch_data.DataLoader(gta5_set, batch_size=batch_size_ls, shuffle=True, num_workers=4, pin_memory=True)
    ...
    source_loader_full = torch_data.DataLoader(gta5_set_full, batch_size=batch_size_hs, shuffle=True, num_workers=4, pin_memory=True)
    ...
    target_loader= torch_data.DataLoader(city_set, batch_size=batch_size_ls, shuffle=True, num_workers=4, pin_memory=True)
    ...
    target_loader_full= torch_data.DataLoader(city_set_full, batch_size=batch_size_hs, shuffle=True, num_workers=4, pin_memory=True)
