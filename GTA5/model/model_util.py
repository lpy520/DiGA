...
class SPADEResBlocks(nn.Module):
    def __init__(self, num_blocks, dim, num_classes = 4, pad_type='zero'):
...
class SPADEResBlock(nn.Module):
    def __init__(self, dim, pad_type='zero', num_classes = 4):
...
class SPADE(nn.Module):
    def __init__(self, norm_nc, label_nc = 4, ks=3):
        super().__init__()
